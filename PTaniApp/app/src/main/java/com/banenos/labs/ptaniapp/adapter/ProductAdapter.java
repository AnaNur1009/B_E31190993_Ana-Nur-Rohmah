package com.banenos.labs.ptaniapp.adapter;
...
import com.banenos.labs.ptaniapp.activity.BaseActivity;
import com.banenos.labs.ptaniapp.activity.ProductActivity;
import com.banenos.labs.ptaniapp.activity.ProductViewActivity;
import com.banenos.labs.ptaniapp.interfaces.AddorRemoveCallbacks;
import com.banenos.labs.ptaniapp.model.Cart;
import com.banenos.labs.ptaniapp.model.Product;
        ...
        if (!cartList.isEmpty()) {
            for (int i = 0; i < cartList.size(); i++) {
                if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                    ...
                    holder.subTotal.setText(_quantity + "X" + _price + "= Rp." + _subtotal);
                ...
                if (pQuantity >= 1) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                            ...
                            holder.subTotal.setText(total_item + "X" + holder.price.getText().toString() + "= Rp." + _subtotal);
        ...
        holder.addToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Integer.parseInt(_quantity) != 0) {
                    ...
                    Toast.makeText(context, "Harap Tambahkan Jumlah", Toast.LENGTH_SHORT).show();
                }
