...
import com.banenos.labs.ptaniapp.activity.CartActivity;
import com.banenos.labs.ptaniapp.activity.MainActivity;
import com.banenos.labs.ptaniapp.adapter.CheckoutCartAdapter;
import com.banenos.labs.ptaniapp.model.Cart;
import com.banenos.labs.ptaniapp.model.Order;
...
public class ConfirmFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        orderNo = "Order #" + (10000 + rnd.nextInt(900000));
    ...
    private void showCustomDialog() {
        ...
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE); //sebelum
        // Sertakan file dialog.xml
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //Judul fragmen
        getActivity().setTitle("Konfirmasi");
    }
